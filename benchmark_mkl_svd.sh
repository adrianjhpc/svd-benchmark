...
do
  mpirun -n 4 ./scalapack_mkl $i $i 2 2
  mpirun -n 4 ./scalapack_mkl $i $i 2 2
  mpirun -n 4 ./scalapack_mkl $i $i 2 2
  mpirun -n 4 ./scalapack_mkl $i $i 4 1
  mpirun -n 4 ./scalapack_mkl $i $i 4 1
  mpirun -n 4 ./scalapack_mkl $i $i 4 1
  mpirun -n 8 ./scalapack_mkl $i $i 4 2
  mpirun -n 8 ./scalapack_mkl $i $i 4 2
  mpirun -n 8 ./scalapack_mkl $i $i 4 2
  mpirun -n 8 ./scalapack_mkl $i $i 8 1
  mpirun -n 8 ./scalapack_mkl $i $i 8 1
  mpirun -n 8 ./scalapack_mkl $i $i 8 1
done
...
#do
 # mpirun -n 8 ./scalapack_mkl $i $(( $i/8 ))
 # mpirun -n 8 ./scalapack_mkl $i $(( $i/8 ))
 # mpirun -n 8 ./scalapack_mkl $i $(( $i/8 ))
#done
